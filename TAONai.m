...
FILENAME = TAONgetfilename(defaultAnswer, opts, filetype, filetypeUPPER); %,'mtbtemp.csv'); % 'defaulttestfile' goes last
...
% y^2 = x^3 + ax + b % general form of equation
